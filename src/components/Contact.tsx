      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-16">
        <div className="max-w-2xl">
          ...
          <div className="space-y-6">
            <a href="mailto:harishsaini@portfoliodesign.com" className="block text-2xl md:text-4xl text-white hover:text-white/60 transition-colors tracking-tight font-medium">
